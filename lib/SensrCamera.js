    ...
    if (sessionId) {
        ...
        if (requestType === 'start') {
            ...
            if (sessionInfo) {
                ...
                var srtpDestinationUrl = 'srtp://' + sessionInfo.address + ':' + sessionInfo.video_port + '?rtcpport=' + sessionInfo.video_port + '&localrtcpport=' + sessionInfo.video_port + '&pkt_size=1378',
                    streamOptions = {
                        sourceUrl: self.options.live,
                        destinationUrl: srtpDestinationUrl,
                        ...
                        ssrc: videoInfo.ssrc || 1,
                        rtcpInterval: videoInfo.rtcp_interval,
                        mtu: videoInfo.mtu
                    };

                self.log(videoInfo, streamOptions);
